			...
			<div className="box-table-pengguna mt-3  ms-3  d-flex flex-column">
				<div>
					<div className="d-flex justify-content-between ">
						<p className="labelPengguna ms-4 mt-4">Pengguna Buyer</p>
					...
					<div className="d-flex me-4 justify-content-end mt-2">
						<div class="collapse filterCollaps " id="filter-collapse">
							<div class="card-collapse-pengguna-buyer d-flex flex-column shadow bg-white ">
								...
								<Button variant="outline-danger" className="btn-hapus mx-2 d-flex align-items-center justify-content- center">
