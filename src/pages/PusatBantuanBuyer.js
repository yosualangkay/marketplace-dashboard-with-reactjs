									...
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
										<g id="Group">
											<g id="IONIcon/I/information/circle/outline">
                                             ...
                                             <Link to="/pusatbantuan/buyer" style={{ textDecoration: "none", color: "#253863" }}>Detail Bantuan</Link>
								</div>
							</li>
							<li class="breadcrumb-item active mt-1 " aria-current="page">
								<div className="d-flex ">
				...
				<div className="detail  d-flex flex-column  mx-auto mt-3  ms-3">
					<div className="box-profile mx-auto pb-4 pt-3 d-flex ">
						<div className="d-flex  name-profile ">
							<div className="pict-bantuan-buyer ">
							...
							<div className="info mx-3 mt-4 pb-5">
								<Row>
									...
									<Col className="input-form">
										<input type="text" disabled className="form-control" placeholder="001- BUYER" />
									</Col>
								</Row>
								<Row className="my-3">
									<Col className="label-form">Kategori Bantuan</Col>
									<Col className="input-form">
										<input type="text" disabled className="form-control" placeholder="Barang Tidak Sesuai" />
									</Col>
								</Row>
								<Row className="  my-3">
									<Col className="label-form">Nomor Transaksi</Col>
									<Col className="input-form">
										<input type="text" disabled className="form-control" placeholder="INV/20202020/XX/XV/554364534" />
									</Col>
								</Row>
								<Row className="  my-3">
								...
								<Row className="  my-3">
									...
									<Col className="input-form">
										<textarea
											...
											placeholder="Barang yang saya dapatkan tidak sesuai dengan yang ada di deskripsi"
											disabled
										/>
									</Col>
								</Row>
...
export default PusatBantuanBuyer;
